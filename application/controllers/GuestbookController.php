...
class GuestbookController extends Zend_Controller_Action
{
    ...
    public function signAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
        	$ns = new Zend_Session_Namespace('gbcounter');
            if (isset($ns->counter) && $ns->counter > 3) {
            	throw new Zend_Exception('You have exceeded your number of failed post attempts.  Please try again later.');
            }
            ...
            if ($form->isValid($request->getPost())) {
                ...
                // into our model:
                $table = new Default_Model_DbTable_Guestbook();
